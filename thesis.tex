...
An analysis of the distribution of wall clock time among the ZFS components involved in synchronous writes reveals that block-device-oriented abstractions and data structures account for the vast majority of the overall latency for this type of IO operation.
...
Instead, they only modify DRAM buffers, such as pages in the Linux page cache, and return to userspace.
