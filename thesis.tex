...
We ask ourselves\todo{language} the following questions:
\begin{itemize}[noitemsep]
...
\end{itemize}
As an alternative to virtualizing just the code related to ZIL persistence, we experimented with virtualizing the direct users of the ZIL code one layer up\todo{language} the stack.
...
The vtable interface\todo{code?} is clean and does not leak implementation details.
