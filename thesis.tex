...
The more likely cause is the latency overhead added by the layering.
For example, the \textit{fio-growing} workload, which purely latency-bound, achieves 126k IOPS at scaling factor 1 on ZFS+ZIL-PMEM but only 28.6k IOPS on XFS+ZVOL+ZIL-PMEM.
