...
\todo{explain in more detail why ZIL-PMEM in OpenZFS is somewhat of a cross-media filesystem}
...
At the OpenZFS 2020 Developer summit, a prototype for a ZIO pipeline bypass for the ZIL for fast SLOG devices was presented by Saji Nair of storage vendor Nutanix\footnote{
    %\url{https://www.google.com/url?q=https://openzfs.org/wiki/OpenZFS_Developer_Summit_2020_talks%23ZIL_Design_Challenges_for_Fast_Media_.28Saji_Nair.29&sa=D&source=editors&ust=1617021239103000&usg=AOvVaw1fecQcHh1i3X-DtsHaKC5S}
    % \todo{broken URL}
}.
...
We classified Strata as a hybrid file system in Section 3.1\todo{fixthis} because it consists of both a userspace library and an in-kernel component.
...
Many databases implement some variant of ARIES which provides features that exceed the needs of file system journaling. Some techniques developed in the database community might be applicable to our work, though.\todo{too weak, not really relevant or refrred to anywheredrop this section?}
