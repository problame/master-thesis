...
\begin{description}
    ...
    \item[ZIL Header Updates]
        ...
        The role of \lstinline{zil_sync} is to modify the dirty copy of the ZIL header that is stored in \textit{objset_phys_t::os_zil_header}.
    ...
    \item[WR\_NEED\_COPY Handling] 

    \item[Replay Adaptation] 
\end{description}
