...
We execute these benchmarks on different storage stacks that represent different usage scenarios for ZFS with ZIL-PMEM.
We present and discuss the results in the subsequent subsections.

Our benchmarking suite supports the following workloads.
All of them share a scaling factor that increases the degree of concurrent synchronous I/O operations issued by the application.
\begin{description}
