...
More experimentation and practical experience with ZIL-PMEM is necessary to determine which features are useful in practice, how they can be realized and how they interact with the existing requirements.
...
The code that is responsible for persisting log entries and for updating the ZIL header resides in ZIL-kind-specific subclasses.
