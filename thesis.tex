...
\section{PRB DRAM Data Structure}
...
\end{description}
The following Figure~\ref{fig:prb_chunk_ownership_cycle__transitions} visualizes the different owners of a chunk over its lifetime.
Figure~\ref{fig:prb_chunk_ownership_cycle__example} then provides an example.
