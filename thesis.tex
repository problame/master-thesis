...
The Linux kernel's \lstinline{/dev/pmem} pseudo block device allows existing block device consumers to benefit from PMEM's high throughput and low latency without modification.
