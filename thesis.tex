...
\begin{description}
    ...
    \item[WR\_NEED\_COPY Chunking]
        ...
        Whereas the repeated chunk acquisition and dependency tracking during each HDL write incurs a small overhead, it also increases fairness among HDLs if there is contention for commit slots.
