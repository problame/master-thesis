...
\todo{briefly remind the reader of how gc works, refer to lists ection above}
\todo{explain how chunks are emptied by invalidating the header, zero log guid}
\todo{explain the system behavior of what happens if the chunk is full}
