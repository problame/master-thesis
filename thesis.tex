...
The allocatable space on the device is thus never read or written through ZIO and free to use for ZIL-PMEM.
Note that reads and writes VDEV labels\todo{need to explain this? short analogy: partition header} are located outside of the allocatable space and continue to be written through block IO.
