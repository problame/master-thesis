...
The number of commit slots is determined by the \lstinline{ncommitters} argument\todo{param?} during PRB construction.
...
The next step is the selection of a target PMEM chunk that has sufficient space for the entry. We tie this task to the commit slot mechanism.
...
As explained in Section~\ref{prb:di:chunkownership}, a commit slot can own up to one chunk.
