...
\begin{itemize}[noitemsep]
    \item PMEM SLOG vdevs must be recognized as such when they are added to the pool.
...
In a first step, we make the vdev layer generally aware of persistent memory devices.
In the second step, we present how ZIL-PMEM reserves the allocatable space on PMEM SLOGs.
