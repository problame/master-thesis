...
In this chapter we describe how we add explicit support for PMEM to ZFS.
Our goal is to disable the SPA's metaslab allocation on PMEM SLOG devices so that ZIL-PMEM can use the allocatable space as PRB chunks.
...
For ZIL-PMEM, we need to disable metaslab allocation on the PMEM SLOG to make the allocatable space available for PRB/HDL.
...
In this section we describe how we use PRB/HDL to implement the ZIL-PMEM ZIL Kind.
